...
def trigonal_diamond_lattice_get_nn_indices(index, n, periodic_bounds=False):
    ...
    if not 0 <= index < trigonal_dimond_nr_lattice_sites(n):
        return neighbors

    y, x = trigonal_dimond_index_to_row_col(index, n)
    ...
    for xi, yi in [
        ...
        neighbors.append(
            trigonal_dimond_row_col_to_index(yi, xi, n, periodic_bounds=periodic_bounds)
        )
...
def trigonal_dimond_nr_lattice_sites(n):
    assert n > 0

    return (n + 1) * (n + 1)


def trigonal_dimond_index_to_row_col(index, n):
    assert n > 0
...
def trigonal_dimond_row_col_to_index(row, col, n, periodic_bounds=True):
    assert n > 0
...
if __name__ == "__main__":
    ...
    # print(trigonal_dimond_index_to_row_col(0, 2))
    # print(trigonal_dimond_index_to_row_col(1, 2))
    # print(trigonal_dimond_index_to_row_col(2, 2))
    # print(trigonal_dimond_index_to_row_col(3, 2))
    # print(trigonal_dimond_index_to_row_col(4, 2))
    # print(trigonal_dimond_index_to_row_col(5, 2))
    # print(trigonal_dimond_index_to_row_col(6, 2))
    # print(trigonal_dimond_index_to_row_col(7, 2))
    # print(trigonal_dimond_index_to_row_col(8, 2))

    # print(trigonal_dimond_row_col_to_index(0, 0, 2))
    # print(trigonal_dimond_row_col_to_index(1, 0, 2))
    # print(trigonal_dimond_row_col_to_index(1, 1, 2))
    # print(trigonal_dimond_row_col_to_index(2, 0, 2))
    # print(trigonal_dimond_row_col_to_index(2, 1, 2))
    # print(trigonal_dimond_row_col_to_index(2, 2, 2))
    # print(trigonal_dimond_row_col_to_index(3, 0, 2))
    # print(trigonal_dimond_row_col_to_index(3, 1, 2))
    # print(trigonal_dimond_row_col_to_index(4, 0, 2))
